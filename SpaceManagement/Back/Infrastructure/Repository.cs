...
namespace SpaceManagment.Infrastructure
{
      ...
      where TEntity : class
    {
        ...
        #region Async Method
        public virtual async Task<TEntity> GetByIdAsync(CancellationToken cancellationToken = default(CancellationToken), params object[] ids)
        {
